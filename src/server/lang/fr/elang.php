...
$string['Close'] = 'Fermer';
$string['Cue Listing'] = 'Liste des séquences';
...
$string['Get a pdf version'] = 'Obtenir une version pdf';
...
$string['Limit per page'] = 'Limite par page';
$string['modulename_help'] = "Utilisez le module «Paysage d'écoute» pour...";
...
$string['Not Found'] = 'Non trouvé';
$string['Not Implemented'] = 'Non implanté';
$string['pdfcue'] = '%s. %s --> %s';
