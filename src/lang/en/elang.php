...
$string['subtitle_help'] = "Upload a file with UTF-8 encoding";
...
$string['titlelength_config'] = 'This defines sequence title length';
$string['titlelength_error'] = 'You should enter a number here. Typical value is 100.';
$string['titlelength_help'] = 'This defines sequence title length';
$string['titlelength'] = 'Sequence title length';
